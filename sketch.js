...
function preload() {
  ...
  score_1=loadImage("images/safezone.png");
...
function setup() {
  ...
  score=createSprite(640,16,10,10);
  score.addImage(score_1);
  score.scale=0.085;

  score1=createSprite(610,16,10,10);
  score1.addImage(score_1);
  score1.scale=0.085;

  score2=createSprite(670,16,10,10);
  score2.addImage(score_1);
  score2.scale=0.085;
...
function draw() {
  ...
  if(keyDown(UP_ARROW)){
   ...
   if(player.isTouching(ghost1||ghost2||ghost3||ghost4)){
